...
{
    public interface IShippingMethodPluginManager : IPluginManager<IShippingProviderPlugin>
    {
        /// <summary>
        ...
        Task<IList<IShippingProviderPlugin>> LoadActivePluginsAsync(Customer customer = null, int storeId = 0, string systemName = null);
        ...
        bool IsPluginActive(IShippingProviderPlugin shippingProvider);
