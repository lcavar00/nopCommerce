...
{
    public partial class ForeignMsSqlNopDataProvider : BaseDataProvider, INopDataProvider
    {
        ...
        protected virtual SqlConnectionStringBuilder GetConnectionStringBuilder()
        {
            ...
            var filePath = fileProvider.MapPath(ImportExportDefaults.ConnectionStringFilePath);

            if (fileProvider.FileExists(filePath))
            {
                var text = fileProvider.ReadAllText(ImportExportDefaults.ConnectionStringFilePath, Encoding.UTF8);
